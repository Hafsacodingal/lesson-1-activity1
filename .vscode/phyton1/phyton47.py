...
while lo<=hi:
    ...
    steps+=1
    if scores[mid]==target:
        print("Binary search :index=",mid,"|steps",steps,"|O(logn)")
        break
    elif scores[mid]<target:
        lo=mid+1
    else:
